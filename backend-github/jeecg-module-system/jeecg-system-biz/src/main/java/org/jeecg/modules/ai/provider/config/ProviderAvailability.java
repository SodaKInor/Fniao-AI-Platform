...
import org.jeecg.modules.ai.provider.adapter.draft.DraftEndpoint;
...
public final class ProviderAvailability {
    ...
    private final org.jeecg.modules.ai.provider.adapter.ProviderObservations observations;

    public ProviderAvailability(ProviderProperties properties, org.jeecg.modules.ai.provider.adapter.ProviderObservations observations) {
    ...
    org.jeecg.modules.ai.provider.adapter.ProviderObservations observations() { return observations; }
