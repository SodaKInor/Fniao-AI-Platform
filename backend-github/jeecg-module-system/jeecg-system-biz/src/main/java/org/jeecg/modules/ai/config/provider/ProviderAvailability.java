...
public final class ProviderAvailability {
    ...
    public String modeReason() {
        ...
        try {
            new DraftEndpoint(properties.getBaseUrl(), properties.getApprovedOrigin(), properties.getApiPath(), false);
    ...
    public String reason(Capability capability) {
        ...
        if (!capability.isSimulated() || !ProviderRequestChecks.binding(capability.getSnapshot(), "mock", "mock-v1")) {
