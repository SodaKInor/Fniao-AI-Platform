package org.jeecg.modules.ai.storage;
...
final class ImageFileVerifier {
    private final int maxDimension;
    ImageFileVerifier(int maxDimension) { this.maxDimension=maxDimension; }
    ...
    void verify(Path path, String mediaType) throws IOException {
