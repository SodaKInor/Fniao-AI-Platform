...
public class TabAiHistoryServiceImpl extends ServiceImpl<TabAiHistoryMapper, TabAiHistory> implements ITabAiHistoryService {
    ...
    @Value("${wgai.features.asr.enabled:false}")
    private boolean asrEnabled;

    @Value("${wgai.features.camera.enabled:false}")
    private boolean cameraEnabled;

    @Value("${wgai.contracts.asr.host:}")
    private String asrHost;

    @Value("${wgai.contracts.asr.port:}")
    private String asrPort;

    @Value("${wgai.contracts.asr.protocol:http}")
    private String asrProtocol;

    @Value("${wgai.contracts.camera.stream-url:}")
    ...
    public Result<?> aiAudio(String path,String uplpadPath) {
        ...
        BaseSpeechRecognizer sr = Sdk.GetSpeechRecognizer(asrHost, asrPort, asrProtocol);
...
//        System.out.println("yyy"+rsp.result);
    ...
    public void sendUrl() {
        ...
        String rtspUrl=cameraStreamUrl;
